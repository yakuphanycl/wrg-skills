...
| [`mcp-audit`](skills/mcp-audit/) | "audit my MCP server", "score my MCP tools", "check tool discoverability", "/mcp-audit" | Audit a FastMCP server's tool surface — discoverability scoring (1-5 per tool), return-shape consistency, test coverage gaps, decay candidates. Outputs an evidence-only Markdown report with a "this-week pick" of ≤1hr fixes. Battle-tested across [WRG#295](https://github.com/yakuphanycl/WinstonRedGuard/pull/295) (32 tools, 2.81/5 avg) and [instinct#26](https://github.com/yakuphanycl/instinct/pull/26) (22 tools, 4.91/5 avg). |
